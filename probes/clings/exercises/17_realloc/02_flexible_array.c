 ...
 *
 * The sizeof operator only returns the size of the struct itself, not the size of the array.
...
int main(void) {
    ...
    // TODO: Allocate memory for the struct AND the initial values.
    // Why is this allocation incorrect for a Flexible Array Member?
